...
?>
            <div class="box intro">
              ...
              <div class="box__bottom">
                ...
                <div class="intro__btn">
                  <button>
                    <a
                      href="https://github.com/KimHyunLo/REACT-API"
                      target="_blank"
                  ...
                  <button>
                    <a
                      href="https://reactapisite.netlify.app/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Visit Site
          ...
          <div class="box info">
            <li>
              <p>
                React Api Site는 React프레임워크를 이용해 여러 API소스를
                활용하여 만든 프로젝트입니다. React 프레임워크의 장점을 활용해
                페이지간 이동이 빠르고, API를 이용해 다채로운 컨텐츠를
                만들었습니다.
              </p>
            </li>
            <li>
          ...
          <div class="box webCont">
            <img src="./assets/img/project/reactweb.png" alt="image" />
          </div>
          <div class="last__box">
<?php
  include "include/menu.php";
?>
            <img src="./assets/img/project/exReact.png" alt="image" />
            <a name="vue" class="next__btn link"></a>
          </div>
        </div>
      </section>
    </div>
